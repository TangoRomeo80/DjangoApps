...
urlpatterns = [
    ...
    path('products/', views.ProductList.as_view()), # Viewset
    path('products/<int:pk>/', views.ProductDetail.as_view()), # viewset using pk
    path('collections/', views.CollectionList.as_view()), # Viewset
    path('collections/<int:pk>/', views.CollectionDetail.as_view()), # Viewset
]